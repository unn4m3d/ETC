...
namespace ETC.Updates
{
	...
	/// </summary>
	public class ChannelDifferenceTooLong : IDifference
	{
		private TLChannelDifferenceTooLong m_diff;
		
		public ChannelDifferenceTooLong(TLChannelDifferenceTooLong d)
		{
			m_diff = d;
		}
		...
		{
			return m_diff.messages.lists.Select(x => MessageFactory.FromMessage(x)).ToList();
		}
